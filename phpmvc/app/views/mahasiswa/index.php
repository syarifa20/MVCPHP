        ...
        <form action="<?= BASEURL; ?>/mahasiswa/tambah" method="post">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="jurusan" name="jurusan">
              ...
              <option value="Teknik Mesin">Teknik Mesin Las</option>
              <option value="Teknik Industri">Teknik Pertanian</option>
              <option value="Teknik Pangan">Teknik Multimedia</option>
              <option value="Teknik Planologi">Teknik Perkebunan</option>
              <option value="Teknik Lingkungan">Teknik Perikanan</option>
            </select>
          </div>
